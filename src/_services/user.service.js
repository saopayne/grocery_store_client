...
function register(user) {
    ...
    return fetch(`https://guarded-brook-31463.herokuapp.comusers/register`, requestOptions)
        .then(handleResponse);
}
...
function update(user) {
    ...
    return fetch(`https://guarded-brook-31463.herokuapp.comusers/${user.id}`, requestOptions)
        .then(handleResponse);
}
